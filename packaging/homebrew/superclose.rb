cask "superclose" do
  ...
  url "https://github.com/kevin/superclose/releases/download/v#{version}/SuperClose-#{version}.zip",
      verified: "github.com/kevin/superclose/"
  name "SuperClose"
  desc "Bulk hide, quit, and force-quit helper for macOS"
  homepage "https://github.com/kevin/superclose"
